...
class Database_2024 {
    ...
    func resetDraft() {
        ...
        allPlayers=[
            ...
            PlayerData(num: 5, numPosPick: 4, numRookie: 0, name: "Amon-Ra St. Brown", team: "DET", position: "WR", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 6, numPosPick: 2, numRookie: 0, name: "Breece Hall", team: "NYJ", position: "RB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 7, numPosPick: 5, numRookie: 0, name: "Justin Jefferson", team: "MIN", position: "WR", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 8, numPosPick: 3, numRookie: 0, name: "Bijan Robinson", team: "ATL", position: "RB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 9, numPosPick: 6, numRookie: 0, name: "A.J. Brown", team: "PHI", position: "WR", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 10, numPosPick: 7, numRookie: 0, name: "Garrett Wilson", team: "NYJ", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 11, numPosPick: 4, numRookie: 0, name: "Jahmyr Gibbs", team: "DET", position: "RB", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 12, numPosPick: 5, numRookie: 0, name: "Jonathan Taylor", team: "IND", position: "RB", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 13, numPosPick: 8, numRookie: 0, name: "Puka Nacua", team: "LAR", position: "WR", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 14, numPosPick: 9, numRookie: 1, name: "Marvin Harrison Jr.", team: "ARI", position: "WR", byeWeek: 11, isTopPlayer: true, isRookie: true),
            PlayerData(num: 15, numPosPick: 6, numRookie: 0, name: "Saquon Barkley", team: "PHI", position: "RB", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 16, numPosPick: 10, numRookie: 0, name: "Davante Adams", team: "LV", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 17, numPosPick: 11, numRookie: 0, name: "Drake London", team: "ATL", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 18, numPosPick: 12, numRookie: 0, name: "Chris Olave", team: "NO", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 19, numPosPick: 1, numRookie: 0, name: "Josh Allen", team: "BUF", position: "QB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 20, numPosPick: 7, numRookie: 0, name: "Travis Etienne Jr.", team: "JAC", position: "RB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 21, numPosPick: 13, numRookie: 0, name: "Jaylen Waddle", team: "MIA", position: "WR", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 22, numPosPick: 2, numRookie: 0, name: "Jalen Hurts", team: "PHI", position: "QB", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 23, numPosPick: 14, numRookie: 0, name: "Michael Pittman Jr.", team: "IND", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 24, numPosPick: 15, numRookie: 0, name: "Cooper Kupp", team: "LAR", position: "WR", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 25, numPosPick: 16, numRookie: 0, name: "Mike Evans", team: "TB", position: "WR", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 26, numPosPick: 17, numRookie: 0, name: "Nico Collins", team: "HOU", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 27, numPosPick: 1, numRookie: 0, name: "Sam LaPorta", team: "DET", position: "TE", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 28, numPosPick: 8, numRookie: 0, name: "Kyren Williams", team: "LAR", position: "RB", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 29, numPosPick: 18, numRookie: 0, name: "Brandon Aiyuk", team: "SF", position: "WR", byeWeek: 9, isTopPlayer: true, isRookie: false),
            PlayerData(num: 30, numPosPick: 2, numRookie: 0, name: "Travis Kelce", team: "KC", position: "TE", byeWeek: 6, isTopPlayer: true, isRookie: false),
            ...
            PlayerData(num: 32, numPosPick: 9, numRookie: 0, name: "Isiah Pacheco", team: "KC", position: "RB", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 33, numPosPick: 4, numRookie: 0, name: "Lamar Jackson", team: "BAL", position: "QB", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 34, numPosPick: 19, numRookie: 0, name: "Deebo Samuel Sr.", team: "SF", position: "WR", byeWeek: 9, isTopPlayer: true, isRookie: false),
            PlayerData(num: 35, numPosPick: 20, numRookie: 0, name: "DJ Moore", team: "CHI", position: "WR", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 36, numPosPick: 10, numRookie: 0, name: "De'Von Achane", team: "MIA", position: "RB", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 37, numPosPick: 21, numRookie: 0, name: "DeVonta Smith", team: "PHI", position: "WR", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 38, numPosPick: 22, numRookie: 0, name: "DK Metcalf", team: "SEA", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 39, numPosPick: 23, numRookie: 2, name: "Malik Nabers", team: "NYG", position: "WR", byeWeek: 11, isTopPlayer: true, isRookie: true),
            PlayerData(num: 40, numPosPick: 11, numRookie: 0, name: "Derrick Henry", team: "BAL", position: "RB", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 41, numPosPick: 12, numRookie: 0, name: "Rachaad White", team: "TB", position: "RB", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 42, numPosPick: 24, numRookie: 0, name: "Amari Cooper", team: "CLE", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 43, numPosPick: 25, numRookie: 0, name: "Stefon Diggs", team: "HOU", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 44, numPosPick: 13, numRookie: 0, name: "Alvin Kamara", team: "NO", position: "RB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 45, numPosPick: 14, numRookie: 0, name: "James Cook", team: "BUF", position: "RB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 46, numPosPick: 15, numRookie: 0, name: "Josh Jacobs", team: "GB", position: "RB", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 47, numPosPick: 5, numRookie: 0, name: "Anthony Richardson", team: "IND", position: "QB", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 48, numPosPick: 26, numRookie: 0, name: "Tee Higgins", team: "CIN", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 49, numPosPick: 3, numRookie: 0, name: "Trey McBride", team: "ARI", position: "TE", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 50, numPosPick: 27, numRookie: 0, name: "Zay Flowers", team: "BAL", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            ...
            PlayerData(num: 52, numPosPick: 16, numRookie: 0, name: "Joe Mixon", team: "HOU", position: "RB", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 53, numPosPick: 28, numRookie: 0, name: "Terry McLaurin", team: "WAS", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 54, numPosPick: 29, numRookie: 0, name: "Rashee Rice", team: "KC", position: "WR", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 55, numPosPick: 17, numRookie: 0, name: "Kenneth Walker III", team: "SEA", position: "RB", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 56, numPosPick: 30, numRookie: 0, name: "George Pickens", team: "PIT", position: "WR", byeWeek: 9, isTopPlayer: true, isRookie: false),
            PlayerData(num: 57, numPosPick: 31, numRookie: 0, name: "Christian Kirk", team: "JAC", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 58, numPosPick: 7, numRookie: 0, name: "Kyler Murray", team: "ARI", position: "QB", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 59, numPosPick: 32, numRookie: 0, name: "Tank Dell", team: "HOU", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 60, numPosPick: 8, numRookie: 0, name: "Joe Burrow", team: "CIN", position: "QB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 61, numPosPick: 4, numRookie: 0, name: "Mark Andrews", team: "BAL", position: "TE", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 62, numPosPick: 33, numRookie: 0, name: "Chris Godwin", team: "TB", position: "WR", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 63, numPosPick: 9, numRookie: 0, name: "Dak Prescott", team: "DAL", position: "QB", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 64, numPosPick: 5, numRookie: 0, name: "Dalton Kincaid", team: "BUF", position: "TE", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 65, numPosPick: 34, numRookie: 0, name: "Keenan Allen", team: "CHI", position: "WR", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 66, numPosPick: 35, numRookie: 0, name: "Diontae Johnson", team: "CAR", position: "WR", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 67, numPosPick: 18, numRookie: 0, name: "James Conner", team: "ARI", position: "RB", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 68, numPosPick: 19, numRookie: 0, name: "Aaron Jones", team: "MIN", position: "RB", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 69, numPosPick: 20, numRookie: 0, name: "Rhamondre Stevenson", team: "NE", position: "RB", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 70, numPosPick: 10, numRookie: 0, name: "Jordan Love", team: "GB", position: "QB", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 71, numPosPick: 36, numRookie: 0, name: "Calvin Ridley", team: "TEN", position: "WR", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 72, numPosPick: 21, numRookie: 0, name: "David Montgomery", team: "DET", position: "RB", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 73, numPosPick: 22, numRookie: 0, name: "D'Andre Swift", team: "CHI", position: "RB", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 74, numPosPick: 11, numRookie: 3, name: "Jayden Daniels", team: "WAS", position: "QB", byeWeek: 14, isTopPlayer: true, isRookie: true),
            PlayerData(num: 75, numPosPick: 23, numRookie: 0, name: "Najee Harris", team: "PIT", position: "RB", byeWeek: 9, isTopPlayer: true, isRookie: false),
            PlayerData(num: 76, numPosPick: 12, numRookie: 0, name: "Brock Purdy", team: "SF", position: "QB", byeWeek: 9, isTopPlayer: true, isRookie: false),
            PlayerData(num: 77, numPosPick: 6, numRookie: 0, name: "Evan Engram", team: "JAC", position: "TE", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 78, numPosPick: 24, numRookie: 0, name: "Zamir White", team: "LV", position: "RB", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 79, numPosPick: 7, numRookie: 0, name: "Kyle Pitts", team: "ATL", position: "TE", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 80, numPosPick: 25, numRookie: 0, name: "Javonte Williams", team: "DEN", position: "RB", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 81, numPosPick: 37, numRookie: 0, name: "Jayden Reed", team: "GB", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 82, numPosPick: 26, numRookie: 0, name: "Raheem Mostert", team: "MIA", position: "RB", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 83, numPosPick: 38, numRookie: 0, name: "Jaxon Smith-Njigba", team: "SEA", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 84, numPosPick: 8, numRookie: 0, name: "George Kittle", team: "SF", position: "TE", byeWeek: 9, isTopPlayer: true, isRookie: false),
            PlayerData(num: 85, numPosPick: 27, numRookie: 0, name: "Tony Pollard", team: "TEN", position: "RB", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 86, numPosPick: 13, numRookie: 4, name: "Caleb Williams", team: "CHI", position: "QB", byeWeek: 7, isTopPlayer: true, isRookie: true),
            PlayerData(num: 87, numPosPick: 14, numRookie: 0, name: "Tua Tagovailoa", team: "MIA", position: "QB", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 88, numPosPick: 28, numRookie: 0, name: "Jaylen Warren", team: "PIT", position: "RB", byeWeek: 9, isTopPlayer: true, isRookie: false),
            PlayerData(num: 89, numPosPick: 39, numRookie: 0, name: "DeAndre Hopkins", team: "TEN", position: "WR", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 90, numPosPick: 15, numRookie: 0, name: "Jared Goff", team: "DET", position: "QB", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 91, numPosPick: 40, numRookie: 5, name: "Xavier Worthy", team: "KC", position: "WR", byeWeek: 6, isTopPlayer: true, isRookie: true),
            PlayerData(num: 92, numPosPick: 29, numRookie: 0, name: "Brian Robinson Jr.", team: "WAS", position: "RB", byeWeek: 14, isTopPlayer: true, isRookie: false),
            ...
            PlayerData(num: 94, numPosPick: 30, numRookie: 0, name: "Tyjae Spears", team: "TEN", position: "RB", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 95, numPosPick: 16, numRookie: 0, name: "Trevor Lawrence", team: "JAC", position: "QB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 96, numPosPick: 31, numRookie: 0, name: "Devin Singletary", team: "NYG", position: "RB", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 97, numPosPick: 10, numRookie: 0, name: "David Njoku", team: "CLE", position: "TE", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 98, numPosPick: 41, numRookie: 0, name: "Courtland Sutton", team: "DEN", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 99, numPosPick: 42, numRookie: 6, name: "Rome Odunze", team: "CHI", position: "WR", byeWeek: 7, isTopPlayer: true, isRookie: true),
            PlayerData(num: 100, numPosPick: 43, numRookie: 0, name: "Christian Watson", team: "GB", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 101, numPosPick: 44, numRookie: 0, name: "Jordan Addison", team: "MIN", position: "WR", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 102, numPosPick: 45, numRookie: 0, name: "Hollywood Brown", team: "KC", position: "WR", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 103, numPosPick: 11, numRookie: 0, name: "Dallas Goedert", team: "PHI", position: "TE", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 104, numPosPick: 12, numRookie: 7, name: "Brock Bowers", team: "LV", position: "TE", byeWeek: 10, isTopPlayer: true, isRookie: true),
            PlayerData(num: 105, numPosPick: 46, numRookie: 8, name: "Ladd McConkey", team: "LAC", position: "WR", byeWeek: 5, isTopPlayer: true, isRookie: true),
            PlayerData(num: 106, numPosPick: 17, numRookie: 0, name: "Kirk Cousins", team: "ATL", position: "QB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 107, numPosPick: 18, numRookie: 0, name: "Justin Herbert", team: "LAC", position: "QB", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 108, numPosPick: 32, numRookie: 0, name: "Austin Ekeler", team: "WAS", position: "RB", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 109, numPosPick: 33, numRookie: 0, name: "Chase Brown", team: "CIN", position: "RB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 110, numPosPick: 47, numRookie: 9, name: "Brian Thomas Jr.", team: "JAC", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: true),
            PlayerData(num: 111, numPosPick: 34, numRookie: 0, name: "Zack Moss", team: "CIN", position: "RB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 112, numPosPick: 48, numRookie: 0, name: "Tyler Lockett", team: "SEA", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 113, numPosPick: 35, numRookie: 10, name: "Jonathon Brooks", team: "CAR", position: "RB", byeWeek: 11, isTopPlayer: true, isRookie: true),
            PlayerData(num: 114, numPosPick: 19, numRookie: 0, name: "Matthew Stafford", team: "LAR", position: "QB", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 115, numPosPick: 13, numRookie: 0, name: "Pat Freiermuth", team: "PIT", position: "TE", byeWeek: 9, isTopPlayer: true, isRookie: false),
            PlayerData(num: 116, numPosPick: 49, numRookie: 0, name: "Jakobi Meyers", team: "LV", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 117, numPosPick: 14, numRookie: 0, name: "Dalton Schultz", team: "HOU", position: "TE", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 118, numPosPick: 36, numRookie: 0, name: "Jerome Ford", team: "CLE", position: "RB", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 119, numPosPick: 20, numRookie: 0, name: "Aaron Rodgers", team: "NYJ", position: "QB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 120, numPosPick: 50, numRookie: 0, name: "Jameson Williams", team: "DET", position: "WR", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 121, numPosPick: 37, numRookie: 0, name: "Gus Edwards", team: "LAC", position: "RB", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 122, numPosPick: 51, numRookie: 11, name: "Keon Coleman", team: "BUF", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: true),
            PlayerData(num: 123, numPosPick: 21, numRookie: 0, name: "Deshaun Watson", team: "CLE", position: "QB", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 124, numPosPick: 52, numRookie: 0, name: "Joshua Palmer", team: "LAC", position: "WR", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 125, numPosPick: 38, numRookie: 0, name: "Ezekiel Elliott", team: "DAL", position: "RB", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 126, numPosPick: 39, numRookie: 0, name: "Nick Chubb", team: "CLE", position: "RB", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 127, numPosPick: 53, numRookie: 0, name: "Romeo Doubs", team: "GB", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 128, numPosPick: 54, numRookie: 0, name: "Curtis Samuel", team: "BUF", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 129, numPosPick: 22, numRookie: 0, name: "Geno Smith", team: "SEA", position: "QB", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 130, numPosPick: 15, numRookie: 0, name: "T.J. Hockenson", team: "MIN", position: "TE", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 131, numPosPick: 40, numRookie: 0, name: "Zach Charbonnet", team: "SEA", position: "RB", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 132, numPosPick: 23, numRookie: 0, name: "Baker Mayfield", team: "TB", position: "QB", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 133, numPosPick: 55, numRookie: 0, name: "Rashid Shaheed", team: "NO", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 134, numPosPick: 56, numRookie: 0, name: "Khalil Shakir", team: "BUF", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 135, numPosPick: 41, numRookie: 0, name: "Chuba Hubbard", team: "CAR", position: "RB", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 136, numPosPick: 57, numRookie: 0, name: "Brandin Cooks", team: "DAL", position: "WR", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 137, numPosPick: 58, numRookie: 0, name: "Mike Williams", team: "NYJ", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 138, numPosPick: 59, numRookie: 0, name: "Josh Downs", team: "IND", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 139, numPosPick: 16, numRookie: 0, name: "Luke Musgrave", team: "GB", position: "TE", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 140, numPosPick: 42, numRookie: 0, name: "Rico Dowdle", team: "DAL", position: "RB", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 141, numPosPick: 24, numRookie: 0, name: "Will Levis", team: "TEN", position: "QB", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 142, numPosPick: 43, numRookie: 12, name: "Blake Corum", team: "LAR", position: "RB", byeWeek: 6, isTopPlayer: true, isRookie: true),
            PlayerData(num: 143, numPosPick: 44, numRookie: 0, name: "Antonio Gibson", team: "NE", position: "RB", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 144, numPosPick: 60, numRookie: 0, name: "Jerry Jeudy", team: "CLE", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 145, numPosPick: 45, numRookie: 13, name: "Trey Benson", team: "ARI", position: "RB", byeWeek: 11, isTopPlayer: true, isRookie: true),
            PlayerData(num: 146, numPosPick: 17, numRookie: 0, name: "Cole Kmet", team: "CHI", position: "TE", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 147, numPosPick: 46, numRookie: 0, name: "Jaleel McLaughlin", team: "DEN", position: "RB", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 148, numPosPick: 47, numRookie: 0, name: "Ty Chandler", team: "MIN", position: "RB", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 149, numPosPick: 18, numRookie: 0, name: "Hunter Henry", team: "NE", position: "TE", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 150, numPosPick: 48, numRookie: 0, name: "Tyler Allgeier", team: "ATL", position: "RB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 151, numPosPick: 49, numRookie: 0, name: "J.K. Dobbins", team: "LAC", position: "RB", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 152, numPosPick: 61, numRookie: 0, name: "Adam Thielen", team: "CAR", position: "WR", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 153, numPosPick: 62, numRookie: 0, name: "Gabe Davis", team: "JAC", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 154, numPosPick: 19, numRookie: 0, name: "Tyler Conklin", team: "NYJ", position: "TE", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 155, numPosPick: 63, numRookie: 0, name: "Dontayvion Wicks", team: "GB", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 156, numPosPick: 25, numRookie: 0, name: "Derek Carr", team: "NO", position: "QB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 157, numPosPick: 64, numRookie: 0, name: "DeMario Douglas", team: "NE", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 158, numPosPick: 26, numRookie: 0, name: "Daniel Jones", team: "NYG", position: "QB", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 159, numPosPick: 1, numRookie: 0, name: "Baltimore Ravens", team: "BAL", position: "DST", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 160, numPosPick: 50, numRookie: 14, name: "Ray Davis", team: "BUF", position: "RB", byeWeek: 12, isTopPlayer: true, isRookie: true),
            PlayerData(num: 161, numPosPick: 51, numRookie: 0, name: "Khalil Herbert", team: "CHI", position: "RB", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 162, numPosPick: 65, numRookie: 0, name: "Darnell Mooney", team: "ATL", position: "WR", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 163, numPosPick: 20, numRookie: 0, name: "Cade Otton", team: "TB", position: "TE", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 164, numPosPick: 27, numRookie: 0, name: "Bryce Young", team: "CAR", position: "QB", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 165, numPosPick: 66, numRookie: 0, name: "Jahan Dotson", team: "WAS", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 166, numPosPick: 67, numRookie: 15, name: "Adonai Mitchell", team: "IND", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: true),
            PlayerData(num: 167, numPosPick: 68, numRookie: 0, name: "Michael Wilson", team: "ARI", position: "WR", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 168, numPosPick: 2, numRookie: 0, name: "San Francisco 49ers", team: "SF", position: "DST", byeWeek: 9, isTopPlayer: true, isRookie: false),
            PlayerData(num: 169, numPosPick: 69, numRookie: 16, name: "Ja'Lynn Polk", team: "NE", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: true),
            PlayerData(num: 170, numPosPick: 3, numRookie: 0, name: "New York Jets", team: "NYJ", position: "DST", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 171, numPosPick: 21, numRookie: 0, name: "Taysom Hill", team: "NO", position: "TE", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 172, numPosPick: 52, numRookie: 17, name: "MarShawn Lloyd", team: "GB", position: "RB", byeWeek: 10, isTopPlayer: true, isRookie: true),
            PlayerData(num: 173, numPosPick: 70, numRookie: 0, name: "Wan'Dale Robinson", team: "NYG", position: "WR", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 174, numPosPick: 4, numRookie: 0, name: "Cleveland Browns", team: "CLE", position: "DST", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 175, numPosPick: 5, numRookie: 0, name: "Dallas Cowboys", team: "DAL", position: "DST", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 176, numPosPick: 53, numRookie: 0, name: "Roschon Johnson", team: "CHI", position: "RB", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 177, numPosPick: 54, numRookie: 18, name: "Jaylen Wright", team: "MIA", position: "RB", byeWeek: 6, isTopPlayer: true, isRookie: true),
            PlayerData(num: 178, numPosPick: 71, numRookie: 0, name: "Rashod Bateman", team: "BAL", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 179, numPosPick: 28, numRookie: 0, name: "Sam Darnold", team: "MIN", position: "WR", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 180, numPosPick: 22, numRookie: 0, name: "Noah Fant", team: "SEA", position: "TE", byeWeek: 10, isTopPlayer: true, isRookie: false),
            PlayerData(num: 181, numPosPick: 44, numRookie: 0, name: "Kendre Miller", team: "NO", position: "RB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 182, numPosPick: 72, numRookie: 19, name: "Xavier Legette", team: "CAR", position: "WR", byeWeek: 11, isTopPlayer: true, isRookie: true),
            PlayerData(num: 183, numPosPick: 6, numRookie: 0, name: "Kansas City Chiefs", team: "KC", position: "DST", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 184, numPosPick: 7, numRookie: 0, name: "Pittsburgh Steelers", team: "PIT", position: "DST", byeWeek: 9, isTopPlayer: true, isRookie: false),
            PlayerData(num: 185, numPosPick: 1, numRookie: 0, name: "Justin Tucker", team: "BAL", position: "K", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 186, numPosPick: 23, numRookie: 0, name: "Chigoziem Okonkwo", team: "TEN", position: "TE", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 187, numPosPick: 8, numRookie: 0, name: "Buffalo Bills", team: "BUF", position: "DST", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 188, numPosPick: 56, numRookie: 0, name: "Bucky Irving", team: "TB", position: "RB", byeWeek: 11, isTopPlayer: true, isRookie: false),
            PlayerData(num: 189, numPosPick: 24, numRookie: 0, name: "Juwan Johnson", team: "NO", position: "TE", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 190, numPosPick: 9, numRookie: 0, name: "Philadelphia Eagles", team: "PHI", position: "DST", byeWeek: 5, isTopPlayer: true, isRookie: false),
            PlayerData(num: 191, numPosPick: 2, numRookie: 0, name: "Brandon Aubrey", team: "DAL", position: "K", byeWeek: 7, isTopPlayer: true, isRookie: false),
            PlayerData(num: 192, numPosPick: 29, numRookie: 20, name: "Bo Nix", team: "DEN", position: "QB", byeWeek: 14, isTopPlayer: true, isRookie: true),
            PlayerData(num: 193, numPosPick: 73, numRookie: 0, name: "Demarcus Robinson", team: "LAR", position: "WR", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 194, numPosPick: 3, numRookie: 0, name: "Harrison Butker", team: "KC", position: "K", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 195, numPosPick: 74, numRookie: 0, name: "Marvin Mims Jr.", team: "DEN", position: "WR", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 196, numPosPick: 57, numRookie: 0, name: "Braelon Allen", team: "NYJ", position: "RB", byeWeek: 12, isTopPlayer: true, isRookie: false),
            PlayerData(num: 197, numPosPick: 10, numRookie: 0, name: "Houston Texans", team: "HOU", position: "DST", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 198, numPosPick: 25, numRookie: 0, name: "Isaiah Likely", team: "BAL", position: "TE", byeWeek: 14, isTopPlayer: true, isRookie: false),
            PlayerData(num: 199, numPosPick: 4, numRookie: 0, name: "Jason Sanders", team: "MIA", position: "K", byeWeek: 6, isTopPlayer: true, isRookie: false),
            PlayerData(num: 200, numPosPick: 11, numRookie: 0, name: "Miami Dolphins", team: "MIA", position: "DST", byeWeek: 6, isTopPlayer: true, isRookie: false),
            
            // Not top 200 but still top in position.
            
            // Rest of Quarterbacks.
            PlayerData(num: 0, numPosPick: 30, numRookie: 0, name: "Russell Wilson", team: "PIT", position: "QB", byeWeek: 9, isTopPlayer: false, isRookie: false),
            
            // Rest of Running Backs.
            PlayerData(num: 0, numPosPick: 58, numRookie: 0, name: "Dameon Pierce", team: "HOU", position: "RB", byeWeek: 14, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 59, numRookie: 0, name: "Elijah Mitchell", team: "SF", position: "RB", byeWeek: 9, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 60, numRookie: 0, name: "Alexander Mattison", team: "LV", position: "RB", byeWeek: 10, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 61, numRookie: 0, name: "Tank Bigsby", team: "JAC", position: "RB", byeWeek: 12, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 62, numRookie: 0, name: "Clyde Edwards-Helaire", team: "KC", position: "RB", byeWeek: 6, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 63, numRookie: 0, name: "Kenneth Gainwell", team: "PHI", position: "RB", byeWeek: 5, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 64, numRookie: 0, name: "Justice Hill", team: "BAL", position: "RB", byeWeek: 14, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 65, numRookie: 0, name: "AJ Dillon", team: "GB", position: "RB", byeWeek: 10, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 66, numRookie: 23, name: "Audric Estime", team: "DEN", position: "RB", byeWeek: 14, isTopPlayer: false, isRookie: true),
            PlayerData(num: 0, numPosPick: 67, numRookie: 0, name: "Jamaal Williams", team: "NO", position: "RB", byeWeek: 12, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 68, numRookie: 0, name: "D'Onta Foreman", team: "CLE", position: "RB", byeWeek: 10, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 69, numRookie: 0, name: "Keaton Mitchell", team: "BAL", position: "RB", byeWeek: 14, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 70, numRookie: 0, name: "Miles Sanders", team: "CAR", position: "RB", byeWeek: 11, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 71, numRookie: 24, name: "Kimani Vidal", team: "LAC", position: "RB", byeWeek: 5, isTopPlayer: false, isRookie: true),
            PlayerData(num: 0, numPosPick: 72, numRookie: 25, name: "Tyrone Tracy Jr.", team: "NYG", position: "RB", byeWeek: 11, isTopPlayer: false, isRookie: true),
            PlayerData(num: 0, numPosPick: 73, numRookie: 0, name: "Jordan Mason", team: "SF", position: "RB", byeWeek: 9, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 74, numRookie: 27, name: "Will Shipley", team: "PHI", position: "RB", byeWeek: 5, isTopPlayer: false, isRookie: true),
            PlayerData(num: 0, numPosPick: 75, numRookie: 28, name: "Dylan Laube", team: "LV", position: "RB", byeWeek: 10, isTopPlayer: false, isRookie: true),
            PlayerData(num: 0, numPosPick: 76, numRookie: 0, name: "Trey Sermon", team: "IND", position: "RB", byeWeek: 14, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 77, numRookie: 0, name: "Samaje Perine", team: "DEN", position: "RB", byeWeek: 14, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 78, numRookie: 0, name: "Eric Gray", team: "NYG", position: "RB", byeWeek: 11, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 79, numRookie: 0, name: "Evan Hull", team: "IND", position: "RB", byeWeek: 14, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 80, numRookie: 0, name: "Cordarrelle Patterson", team: "PIT", position: "RB", byeWeek: 9, isTopPlayer: false, isRookie: false),
            
            // Rest of Wide Receivers.
            PlayerData(num: 0, numPosPick: 75, numRookie: 21, name: "Ricky Pearsall", team: "SF", position: "WR", byeWeek: 9, isTopPlayer: false, isRookie: true),
            PlayerData(num: 0, numPosPick: 76, numRookie: 0, name: "Quentin Johnston", team: "LAC", position: "WR", byeWeek: 5, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 77, numRookie: 0, name: "Tyler Boyd", team: "TEN", position: "WR", byeWeek: 5, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 78, numRookie: 0, name: "Darius Slayton", team: "NYG", position: "WR", byeWeek: 11, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 79, numRookie: 22, name: "Jermaine Burton", team: "CIN", position: "WR", byeWeek: 12, isTopPlayer: false, isRookie: true),
            ...
            // Rest of Tight Ends.
            PlayerData(num: 0, numPosPick: 26, numRookie: 26, name: "Ben Sinnott", team: "WAS", position: "TE", byeWeek: 14, isTopPlayer: false, isRookie: true),
            PlayerData(num: 0, numPosPick: 27, numRookie: 0, name: "Mike Gesicki", team: "CIN", position: "TE", byeWeek: 12, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 28, numRookie: 0, name: "Tucker Kraft", team: "GB", position: "TE", byeWeek: 10, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 29, numRookie: 0, name: "Michael Mayer", team: "LV", position: "TE", byeWeek: 10, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 30, numRookie: 0, name: "Jonnu Smith", team: "MIA", position: "TE", byeWeek: 6, isTopPlayer: false, isRookie: false),
            
            // Rest of Defenses
            PlayerData(num: 0, numPosPick: 12, numRookie: 0, name: "New Orleans Saints", team: "NO", position: "DST", byeWeek: 12, isTopPlayer: false, isRookie: false),
            ...
            PlayerData(num: 0, numPosPick: 14, numRookie: 0, name: "Detroit Lions", team: "DET", position: "DST", byeWeek: 5, isTopPlayer: false, isRookie: false),
            ...
            PlayerData(num: 0, numPosPick: 16, numRookie: 0, name: "Jacksonville Jaguars", team: "JAC", position: "DST", byeWeek: 12, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 17, numRookie: 0, name: "Green Bay Packers", team: "GB", position: "DST", byeWeek: 10, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 18, numRookie: 0, name: "Cincinnati Bengals", team: "CIN", position: "DST", byeWeek: 12, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 19, numRookie: 0, name: "Las Vegas Raiders", team: "LV", position: "DST", byeWeek: 10, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 20, numRookie: 0, name: "Minnesota Vikings", team: "MIN", position: "DST", byeWeek: 6, isTopPlayer: false, isRookie: false),
            
            // Rest of Kickers
            PlayerData(num: 0, numPosPick: 5, numRookie: 0, name: "Ka'imi Fairbairn", team: "HOU", position: "K", byeWeek: 14, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 6, numRookie: 0, name: "Jake Moody", team: "SF", position: "K", byeWeek: 9, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 7, numRookie: 0, name: "Jake Elliott", team: "PHI", position: "K", byeWeek: 5, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 8, numRookie: 0, name: "Tyler Bass", team: "BUF", position: "K", byeWeek: 12, isTopPlayer: false, isRookie: false),
            ...
            PlayerData(num: 0, numPosPick: 11, numRookie: 0, name: "Matt Gay", team: "IND", position: "K", byeWeek: 14, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 12, numRookie: 0, name: "Cameron Dicker", team: "LAC", position: "K", byeWeek: 5, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 13, numRookie: 0, name: "Cairo Santos", team: "CHI", position: "K", byeWeek: 7, isTopPlayer: false, isRookie: false),
            PlayerData(num: 0, numPosPick: 14, numRookie: 0, name: "Dustin Hopkins", team: "CLE", position: "K", byeWeek: 10, isTopPlayer: false, isRookie: false),
            ...
            // Rest of Rookies
            PlayerData(num: 0, numPosPick: 0, numRookie: 29, name: "Drake Maye", team: "NE", position: "QB", byeWeek: 14, isTopPlayer: false, isRookie: true),
            PlayerData(num: 0, numPosPick: 0, numRookie: 30, name: "Roman Wilson", team: "PIT", position: "WR", byeWeek: 9, isTopPlayer: false, isRookie: true)
        ]
        changeMade()
    }
    ...
    func billsArray_2024() -> [Cell] {
        ...
        let qb3 = Cell(pos: "QB3", play: "Ben DiNucci")
        let rb1 = Cell(pos: "RB1", play: "James Cook")
        let rb2 = Cell(pos: "RB2", play: "Ray Davis", rookie: "R")
    ...
    func dolphinsArray_2024() -> [Cell] {
        ...
        let rb2 = Cell(pos: "RB2", play: "De'Von Achane")
    ...
    func jetsArray_2024() -> [Cell] {
        ...
        let wr6 = Cell(pos: "WR6", play: "Lance McCutcheon")
    ...
    func patriotsArray_2024() -> [Cell] {
        ...
        let wr1 = Cell(pos: "WR1", play: "Ja'Lynn Polk", rookie: "R")
        let wr2 = Cell(pos: "WR2", play: "Kendrick Bourne")
        let wr3 = Cell(pos: "WR3", play: "DeMario Douglas")
        let wr4 = Cell(pos: "WR4", play: "Jalen Reagor")
        let wr5 = Cell(pos: "WR5", play: "Javon Baker", rookie: "R")
        let wr6 = Cell(pos: "WR6", play: "Tyquan Thornton")
    ...
    func bengalsArray_2024() -> [Cell] {
        ...
        let rb4 = Cell(pos: "RB4", play: "Elijah Collins", rookie: "R")
