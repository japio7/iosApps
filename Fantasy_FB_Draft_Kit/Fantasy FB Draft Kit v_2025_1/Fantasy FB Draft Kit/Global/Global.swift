...
var currentDatabase = Database_2025.shared
...
func leaguesPerYearFunc() -> [Int:Int] {
    let leaguesPerYear = [2020:Database_2020.shared.leagues.count, 2021:Database_2021.shared.leagues.count, 2022:Database_2022.shared.leagues.count, 2023:Database_2023.shared.leagues.count, 2024:Database_2024.shared.leagues.count]
    return leaguesPerYear
}
