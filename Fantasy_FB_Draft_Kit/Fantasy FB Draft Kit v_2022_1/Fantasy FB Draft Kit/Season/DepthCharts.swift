...
class DepthCharts: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        if passedData.year == 0 {
            return Database_2020.shared.depthChartTeamDivision[section]
        } else if passedData.year == 1 {
            return Database_2021.shared.depthChartTeamDivision[section]
        } else if passedData.year == 2 {
            return Database_2022.shared.depthChartTeamDivision[section]
        }
        return nil
    }
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if passedData.year == 0 {
            return Database_2020.shared.depthChartTeams[section].count
        } else if passedData.year == 1 {
            return Database_2021.shared.depthChartTeams[section].count
        } else if passedData.year == 2 {
            return Database_2022.shared.depthChartTeams[section].count
        }
        return 0
    }
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        if passedData.year == 0 {
            return Database_2020.shared.depthChartTeams.count
        } else if passedData.year == 1 {
            return Database_2021.shared.depthChartTeams.count
        } else if passedData.year == 2 {
            return Database_2022.shared.depthChartTeams.count
        }
        return 0
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if passedData.year == 0 {
            cell.textLabel?.text = Database_2020.shared.depthChartTeams[indexPath.section][indexPath.row]
        } else if passedData.year == 1 {
            cell.textLabel?.text = Database_2021.shared.depthChartTeams[indexPath.section][indexPath.row]
        } else if passedData.year == 2 {
            cell.textLabel?.text = Database_2022.shared.depthChartTeams[indexPath.section][indexPath.row]
        }
