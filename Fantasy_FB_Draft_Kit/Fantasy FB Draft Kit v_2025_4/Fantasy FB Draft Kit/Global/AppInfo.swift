...
class AppInfo: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var _array: [[String]] = [
        ...
        ["For more information, please visit \nhttps://github.com/japio7/iosApps/blob/master/Fantasy_FB_Draft_Kit/README.md"]
    ]
