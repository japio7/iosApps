...
class Database_2023 {
    ...
    func resetDraft() {
        allPlayers = [
            ...
            PlayerData(num: 8, numPosPick: 3, numRookie: 0, name: "Saquon Barkley", team: "NYG", position: "RB", byeWeek: 13, isTopPlayer: true, isRookie: false),
            PlayerData(num: 9, numPosPick: 5, numRookie: 0, name: "Stefon Diggs", team: "BUF", position: "WR", byeWeek: 13, isTopPlayer: true, isRookie: false),
            ...
            PlayerData(num: 13, numPosPick: 7, numRookie: 0, name: "Amon-Ra St. Brown", team: "DET", position: "WR", byeWeek: 9, isTopPlayer: true, isRookie: false),
            PlayerData(num: 14, numPosPick: 8, numRookie: 0, name: "Davante Adams", team: "LV", position: "WR", byeWeek: 13, isTopPlayer: true, isRookie: false),
            PlayerData(num: 15, numPosPick: 9, numRookie: 0, name: "A.J. Brown", team: "PHI", position: "WR", byeWeek: 10, isTopPlayer: true, isRookie: false),
