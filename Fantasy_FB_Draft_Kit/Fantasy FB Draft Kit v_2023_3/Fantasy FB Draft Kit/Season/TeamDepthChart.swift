...
class TeamDepthChart: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if passedData.year == 2023 {
            Database_2023.shared.loadTeamData(sec: passedData.sec!, row: passedData.row!, view1: view1, view2: view2, label: label, table: table)
        }
    }
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if passedData.year == year {
            return Database_2023.shared.data.count
        }
        return 0
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var playerData : [Cell] = []
        if passedData.year == year {
            playerData = Database_2023.shared.data
        }
