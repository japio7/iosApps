...
class DepthCharts: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        if passedData.year == year {
            return Database_2023.shared.depthChartTeamDivision[section]
        }
        return nil
    }
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if passedData.year == year {
            return Database_2023.shared.depthChartTeams[section].count
        }
        return 0
    }
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        if passedData.year == year {
            return Database_2023.shared.depthChartTeams.count
        }
        return 0
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if passedData.year == year {
            cell.textLabel?.text = Database_2023.shared.depthChartTeams[indexPath.section][indexPath.row]
        }
