...
class ViewController: UIViewController, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func btnCalculate(_ sender: UIButton) {
        ...
        if txtVehicleCost.text == "" || txtDownPayment.text == "" || txtNumberOfMonths.text == "" || txtAPR.text == "" || txtTax.text == "" {
            lblMessage.text = "Enter a Valid Entry into Missing Field!"
        ...
        else if txtVehicleCost.text == "0" || txtVehicleCost.text == "00" || txtVehicleCost.text == "000" || txtVehicleCost.text == "0000" || txtVehicleCost.text == "00000" || txtVehicleCost.text == "000000" || txtVehicleCost.text == "0000000" {
        ...
        else if Int(txtVehicleCost.text!) == Int(txtDownPayment.text!) {
        ...
        else if Int(txtDownPayment.text!)! > Int(txtVehicleCost.text!)! {
