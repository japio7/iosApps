...
class Cash5: UIViewController {
    ...
    @IBAction func btnGenerate(_ sender: UIButton) {
        ...
        let rand6 = Int(arc4random_uniform(32))+1               // Random number for numbers between 1 and 32.
        let rand7 = Int(arc4random_uniform(32))+1               // Random number for numbers between 1 and 32.
        let rand8 = Int(arc4random_uniform(32))+1               // Random number for numbers between 1 and 32.
        let rand9 = Int(arc4random_uniform(32))+1               // Random number for numbers between 1 and 32.
        let rand10 = Int(arc4random_uniform(32))+1              // Random number for numbers between 1 and 32.
