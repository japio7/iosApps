...
class ViewController: UIViewController, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func textFieldFees(_ sender: TextField) {
        func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
            self.view.endEditing(true)
        }
    }
    ...
    @IBOutlet weak var lblTotalFinancedLabel: UILabel!
    ...
    @IBOutlet weak var lblTotalFinanced: UILabel!
    ...
    @IBAction func btnCalculate(_ sender: UIButton) {
        ...
        var dblFees: Double = 0                        // To hold the Taxable Fees.
        ...
        func paymentStructure() {
            ...
            for _ in 1...intMonths {
                ...
                lblPaymentStructure.textColor = .systemBlue
        ...
        func clearLabels() {
            ...
            lblMonthlyPaymentLabel.text = ""
            lblTotalFinancedLabel.text = ""
            lblTotalInterestLabel.text = ""
            lblTotalTaxLabel.text = ""
            lblTotalAmountLabel.text = ""
            lblMonthlyPayment.text = ""
            lblTotalFinanced.text = ""
        ...
        func setLabels() {
            ...
            lblTotalFinancedLabel.text = "Total Financed:"
        ...
        if txtFees.text! == "" {
            ...
            dblFees = Double(txtFees.text!)!
        }
        if txtVehicleCost.text == "" {
            lblMessage.text = "Enter a Valid Entry into Vehicle Cost Field!"
            clearLabels()
        }
        else if txtDownPayment.text == "" {
            lblMessage.text = "Enter a Valid Entry into Down Payment Field!"
            clearLabels()
        }
        else if txtNumberOfMonths.text == "" {
            lblMessage.text = "Enter a Valid Entry into Number of Months Field!"
            clearLabels()
        }
        else if txtAPR.text == "" {
            lblMessage.text = "Enter a Valid Entry into APR % Rate Field!"
            clearLabels()
        }
        else if txtTax.text == "" {
            lblMessage.text = "Enter a Valid Entry into Tax % Rate Field!"
            clearLabels()
        }
        else if Double(txtVehicleCost.text!)! == 0 {
            lblMessage.text = "Vehicle Cost cannot be 0!"
            clearLabels()
        }
        else if Double(txtNumberOfMonths.text!)! == 0 {
            lblMessage.text = "The Number of Months is Not Valid!"
            clearLabels()
        }
        else if Int(txtNumberOfMonths.text!)! > 84 {
            lblMessage.text = "The Number of Months is Not Valid!"
            clearLabels()
        }
        else if Double(txtVehicleCost.text!) == Double(txtDownPayment.text!) {
            lblMessage.text = "Down Payment cannot Equal Vehicle Cost!"
            clearLabels()
        }
        else if Double(txtDownPayment.text!)! > Double(txtVehicleCost.text!)! {
            lblMessage.text = "Down Payment cannot be Greater than Vehicle Cost!"
            clearLabels()
        }
        else if txtVehicleCost.text != nil && txtDownPayment.text != nil && txtNumberOfMonths.text != nil && Double(txtAPR.text!)! == 0 && txtTax.text != nil {
            dblCost = Double(txtVehicleCost.text!)!
            dblDownPayment = Double(txtDownPayment.text!)!
            intMonths = Int(txtNumberOfMonths.text!)!
            ...
            // Clear the message.
            lblMessage.text = ""
            let dblTotalCost = dblCost + dblFees
            // Get the Total Tax.
            dblTotalTax = ((dblTaxRate/100) * dblTotalCost)
            // Get the amount of the loan.
            dblLoan = dblTotalCost + dblTotalTax - dblDownPayment
            // Get the monthly payment.
            dblMonthlyPayment = dblLoan / Double(intMonths)
            // Get the Total Amount.
            dblTotalAmount = dblTotalCost + dblTotalTax
            // Format the results.
            ...
            let fTotalFinanced = NSNumber(value: dblLoan)
            let fResultTotalFinanced = NumberFormatter.localizedString(from: fTotalFinanced, number: .currency)
            
            // Set Labels
            setLabels()
            lblMonthlyPayment.text = fResultMonthkyPayment
            lblTotalFinanced.text = fResultTotalFinanced
        ...
        else if txtVehicleCost.text != nil && txtDownPayment.text != nil && txtNumberOfMonths.text != nil && txtAPR.text != nil && Double(txtTax.text!)! == 0 {
            dblCost = Double(txtVehicleCost.text!)!
            dblDownPayment = Double(txtDownPayment.text!)!
            intMonths = Int(txtNumberOfMonths.text!)!
            dblTaxRate = Double(txtTax.text!)!
            ...
            // Get the amount of the loan.
            dblLoan = dblTotalCost - dblDownPayment
            // Get the monthly payment.
            ...
            // Get the Total Amount.
            dblTotalAmount = dblTotalCost + dblTotalInterest
            // Format the results.
            let fMonthlyPayment = NSNumber(value: dblMonthlyPayment)
            let fResultMonthkyPayment = NumberFormatter.localizedString(from: fMonthlyPayment, number: .currency)
            ...
            dblTotalInterest = dblMonthlyPayment * Double(intMonths) - dblLoan
            // Get the Total Amount.
            dblTotalAmount = dblTotalCost + dblTotalTax + dblTotalInterest
